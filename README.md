...
`productInProducts(product: IProduct): boolean` - проверка наличия товара в корзине по его id, полученного в параметр метода.
...
`validateInformation(): object` - валидация данных.
